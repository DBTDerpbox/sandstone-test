...
import type { TagClass } from "../../resources/index";
/**
...
export declare type RecipeType<P1 extends string = string, P2 extends string = string, P3 extends string = string> = (RecipeKind<'blasting', CookingRecipe> | RecipeKind<'campfire_cooking', CookingRecipe> | RecipeKind<'crafting_shaped', {
    /**
