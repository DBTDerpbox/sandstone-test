...
import type { MCFunctionClass } from "../resources/index";
...
import type { FunctionResource, ResourceOnlyTypeMap, ResourcePath } from "./resourcesTree";
...
export default class Datapack {
     ...
     */
    getUniqueChildName(childName: string, parentFunction?: ({
        path: ResourcePath;
     ...
     */
    createChildFunction(functionName: string, parentFunction?: ({
        path: ResourcePath;
        children: Map<string, import("./resourcesTree").FolderOrFile<{
            commands: CommandArgs[];
        }, ResourcePath>>;
    ...
    }) | import("../variables/index").ComponentClass | (string | number | boolean | ({
        with?: import("../arguments/index").TextComponentObject[] | undefined;
    } & {
        color?: (Pick<string, never> & {
            trimStart: () => string;
    ...
    }) | import("../variables/index").ComponentClass | any)[])[])[])[])[])[])[])[])[])[])[])[] | import("../variables/index").ComponentClass | (string | number | boolean | ({
        with?: import("../arguments/index").TextComponentObject[] | undefined;
    } & {
        color?: (Pick<string, never> & {
            trimStart: () => string;
    ...
    }) | import("../variables/index").ComponentClass | any)[])[])[])[])[])[])[])[])[])[])[] | undefined) => ObjectiveClass;
    ...
    get rootObjective(): ObjectiveClass;
    /**
    ...
    BasePath: <N extends string | undefined, D extends string | undefined>(basePath: BasePathOptions<N, D>) => BasePathClass<N, D>;
    addResource: <T extends "functions" | "tags" | "advancements" | "predicates" | "loot_tables" | "recipes">(name: string, type: T, resource: Pick<ResourceOnlyTypeMap[T], Exclude<keyof ResourceOnlyTypeMap[T], "path" | "children" | "isResource">>) => void;
