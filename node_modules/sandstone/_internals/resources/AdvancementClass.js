...
exports.AdvancementClass = void 0;
const Resource_1 = require("./Resource");
class AdvancementClass extends Resource_1.ResourceClass {
    constructor(datapack, name, advancement) {
        super(datapack, name);
...
exports.AdvancementClass = AdvancementClass;
