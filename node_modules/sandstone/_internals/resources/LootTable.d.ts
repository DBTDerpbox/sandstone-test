...
import type { Coordinates, ENTITY_SLOTS, LootTableType, MultipleEntitiesArgument, MultiplePlayersArgument } from "../arguments/index";
import type { Datapack } from "../datapack/index";
export declare class LootTableClass extends ResourceClass {
    lootTableJson: LootTableType;
