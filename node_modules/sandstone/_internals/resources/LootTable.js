...
exports.LootTableClass = void 0;
const Resource_1 = require("./Resource");
class LootTableClass extends Resource_1.ResourceClass {
    constructor(datapack, name, lootTable) {
        super(datapack, name);
...
exports.LootTableClass = LootTableClass;
