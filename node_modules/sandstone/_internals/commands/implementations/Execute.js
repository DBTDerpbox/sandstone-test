...
class Execute extends CommandLike {
     ...
     */
    get runOne() {
        console.warn(chalk_1.default.hex('#ff6700')('`runOne` is deprecated. Please use `run` instead: `execute.as("@a").run.give("@s", "minecraft:diamond", 1)`'));
        return this.run;
    }
    /**
     * Runs a single command.
...
__decorate([
    decorators_1.command('rotated', { ...executeConfig, parsers: { '0': index_1.rotationParser } }),
    __metadata("design:type", Object)
        ...
        parsers: {
            '3': (arg, innerArgs) => {
                if (innerArgs[2] === 'matches') {
                    return index_1.rangeParser(arg);
                }
                return arg;
            },
        },
