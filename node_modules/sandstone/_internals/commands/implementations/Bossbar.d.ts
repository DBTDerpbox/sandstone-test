...
declare class BossbarSet extends Command {
     ...
     */
    players: (players?: string | import("../../arguments/index")._ShowAlias | import("../../variables/index").SelectorClass<true, true> | import("../../variables/index").SelectorClass<false, true> | undefined) => void;
    /**
