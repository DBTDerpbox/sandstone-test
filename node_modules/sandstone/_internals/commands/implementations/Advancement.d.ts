...
import type { AdvancementClass } from "../../resources/index";
declare class AdvancementArguments extends Command {
     ...
     */
    only: (advancement: string | AdvancementClass, criterion?: string | undefined) => void;
    /**
     ...
     * @param advancement Specifies a valid namespaced id of the advancement to target.
     */
    from: (advancement: string | AdvancementClass) => void;
    /**
     ...
     * @param advancement Specifies a valid namespaced id of the advancement to target.
     */
    through: (advancement: string | AdvancementClass) => void;
    /**
     ...
     * @param advancement Specifies a valid namespaced id of the advancement to target.
     */
    until: (advancement: string | AdvancementClass) => void;
}
