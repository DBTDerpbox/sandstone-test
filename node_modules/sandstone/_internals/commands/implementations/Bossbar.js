...
class Bossbar extends Command_1.Command {
    constructor() {
         ...
         */
        this.set = (id) => new BossbarSet(this.commandsRoot);
    }
}
__decorate([
...
__decorate([
    decorators_1.command(['bossbar', 'set'], { isRoot: true, executable: false, hasSubcommands: true }),
    __metadata("design:type", Object)
], Bossbar.prototype, "set", void 0);
exports.Bossbar = Bossbar;
class BossbarSet extends Command_1.Command {
    constructor() {
        super(...arguments);
        /**
...
__decorate([
    decorators_1.command('color', { isRoot: true }),
    __metadata("design:type", Object)
], BossbarSet.prototype, "color", void 0);
__decorate([
    decorators_1.command('max', { isRoot: true }),
    __metadata("design:type", Object)
], BossbarSet.prototype, "max", void 0);
__decorate([
    decorators_1.command('name', { isRoot: true }),
    __metadata("design:type", Object)
], BossbarSet.prototype, "name", void 0);
__decorate([
    decorators_1.command('players', { isRoot: true }),
    __metadata("design:type", Object)
], BossbarSet.prototype, "players", void 0);
__decorate([
    decorators_1.command('style', { isRoot: true }),
    __metadata("design:type", Object)
], BossbarSet.prototype, "style", void 0);
__decorate([
    decorators_1.command('value', { isRoot: true }),
    __metadata("design:type", Object)
], BossbarSet.prototype, "value", void 0);
__decorate([
    decorators_1.command('visible', { isRoot: true }),
    __metadata("design:type", Object)
], BossbarSet.prototype, "visible", void 0);
