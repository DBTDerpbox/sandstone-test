...
export declare class Execute<T extends CommandsRootLike> extends CommandLike<T> {
     ...
     */
    get runOne(): (T extends CommandsRoot ? Pick<T, keyof typeof commands> : T);
    /**
     * Runs a single command.
     */
...
export declare class ExecuteWithRun<T extends CommandsRoot> extends Execute<T> {
     ...
     */
    get run(): (T extends CommandsRoot ? Pick<T, keyof typeof commands> & ((callback: () => void) => void) : T & ((callback: () => void) => void));
}
