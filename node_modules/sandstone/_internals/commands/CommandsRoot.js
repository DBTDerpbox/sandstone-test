...
const index_2 = require("./implementations/index");
class CommandsRoot {
    constructor(datapack) {
        ...
        /** COMMANDS */
        // advancement command //
        this.advancement = new index_2.AdvancementCommand(this);
        // attribute command //
        this.attribute = (new index_2.Attribute(this)).attribute;
        // bossbar command //
        this.bossbar = new index_2.Bossbar(this);
        /**
        ...
        // clone command //
        this.clone = (new index_2.Clone(this)).clone;
        // Add a comment //
        /**
        ...
        // data command //
        this.data = new index_2.Data(this);
        // datapack command //
        this.datapack = new index_2.DatapackCommand(this);
        // debug command //
        this.debug = new index_2.Debug(this);
        // defaultgamemode command //
        this.defaultgamemode = (new index_2.DefaultGamemode(this)).defaultgamemode;
        // difficulty command //
        this.difficulty = (new index_2.Difficulty(this)).difficulty;
        // effect command //
        this.effect = (new index_2.Effect(this));
        // enchant command //
        this.enchant = (new index_2.Enchant(this)).enchant;
        // experience command //
        this.experience = new index_2.Experience(this);
        // fill command //
        this.fill = (new index_2.Fill(this)).fill;
        // forceload command //
        this.forceload = new index_2.Forceload(this);
        // function command //
        this.functionCmd = (new index_2.FunctionCommand(this).function);
        /**
        ...
        // gamerule command //
        this.gamerule = (new index_2.GameruleCommand(this)).gamerule;
        /**
        ...
        // loot command //
        this.loot = new index_2.Loot(this);
        // me command //
        /**
        ...
        this.me = (...actions) => { };
        // particle command //
        this.particle = (new index_2.Particle(this)).particle;
        // playsound command //
        /**
        ...
        // recipe command //
        this.recipe = new index_2.RecipeCommand(this);
        // reload command //
        /**
        ...
        this.raw = (...args) => { };
        // replaceitem command //
        this.replaceitem = new index_2.ReplaceItem(this);
        // say command //
        /**
        ...
        this.say = (...messages) => { };
        // schedule command //
        this.schedule = new index_2.Schedule(this);
        // scoreboard command //
        this.scoreboard = new index_2.Scoreboard(this);
        // seed command //
        ...
        this.spreadplayers = (new index_2.SpreadPlayers(this)).spreadplayers;
        /**
         * Stops a given sound.
         *
        ...
        // tag command //
        this.tag = (new index_2.TagCommand(this)).tag;
        // team command //
        this.team = new index_2.Team(this);
        // teammessage command //
        /**
        ...
        // teleport command //
        this.teleport = (new index_2.Teleport(this)).teleport;
        // tell command //
        /**
        ...
        // time command //
        this.time = new index_2.Time(this);
        // title command //
        this.title = (new index_2.Title(this)).title;
        // trigger command //
        this.trigger = (new index_2.Trigger(this)).trigger;
        this.weather = new index_2.Weather(this);
        this.worldborder = new index_2.WorldBorder(this);
        // / ALIAS COMMANDS ///
        // msg command //
    ...
    // execute command //
    get execute() {
        const realExecute = new index_2.ExecuteWithRun(this);
...
__decorate([
    decorators_1.command([], { isRoot: true, registerArguments: false }),
    __metadata("design:type", Object)
