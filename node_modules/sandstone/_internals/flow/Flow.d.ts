...
export declare class Flow {
    ...
    data: {
         ...
         */
        block: (pos: Coordinates, path: string) => {
            value: (string | import("../variables/index").VectorClass<[string, string, string]>)[];
        };
        /**
         ...
         * @param path Data tag to check for.
         */
        entity: (target: SingleEntityArgument, path: string) => {
            value: SingleEntityArgument[];
        };
        /**
         ...
         * @param path Data tag to check for.
         */
        storage: (source: string, path: string) => {
            value: string[];
        };
    };
    /** Logical operators */
    ...
    forRange: <R extends void | Promise<void>>(from: PlayerScore | number, to: PlayerScore | number, callback: (score: PlayerScore) => R) => void | Promise<void>;
    forScore: <R extends void | Promise<void>>(score: PlayerScore | number, condition: ConditionClass | CombinedConditions | ((score: PlayerScore) => ConditionType), modifier: (score: PlayerScore) => void, callback: (score: PlayerScore) => R) => R;
    private register;
